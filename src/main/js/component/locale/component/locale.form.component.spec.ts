...
import { LocaleFormComponent } from "./locale.form.component";
...
import { LocaleMockData } from "../mock/mock.data";

describe("BDD test for LocaleFormComponent.\n", () => {
    let component: LocaleFormComponent;
    ...
    beforeEach(() => {
        ...
        resourcesService.get.and.returnValue(Observable.of(LocaleMockData.RESOURCE_RESPONSE));
        resourcesService.post.and.returnValue(Observable.of(LocaleMockData.RESOURCE_RESPONSE));
    });
   ...
   /* it("Component should have been defined.\n", () => {
    ...
    it("Post method should call post method of ResourcesService.\n", () => {
        component.post();
        expect(resourcesService.post).toHaveBeenCalledWith(component.apiUrl, component.localeForm.getData());
    });
    ...
    describe("Test for name field validation.\n", () => {
        ...
        beforeEach(() => {
            ...
            nameFormControl = component.localeForm.form.get(fieldName);
        });
    ...
    describe("Test for code field validation.\n", () => {
        ...
        beforeEach(() => {
            ...
            codeFormControl = component.localeForm.form.get(fieldName);
        });
